...
@CucumberOptions(
        plugin = {"html:target/cucumber-reports", "json:target/cucumber-reports1.json","rerun:target/rerun.txt"},
        features = "src/test/resources/features/school_features/student_features",    //you DO NOT want to change this; it will look into features directory and it will be recognized by tags
