...
@CucumberOptions(
        plugin = {"html:target/cucumber-reports", "json:target/cucumber-reports3.json","rerun:target/rerun.txt"},
        features = "src/test/resources/features/vyTrack_features",    //you DO NOT want to change this; it will look into features directory and it will be recognized by tags
...
public class VyTrackParallelRunner {
}
